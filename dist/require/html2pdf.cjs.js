...
Worker.prototype.toContainer = function toContainer() {
  return orig.toContainer.call(this).then(function toContainer_pagebreak() {
    ...
    var pxPageHeight = this.opt["html2canvas"] && this.opt["html2canvas"]["width"] ? Math.ceil(this.opt["html2canvas"]["width"] * this.prop.pageSize.inner.ratio) : this.prop.pageSize.inner.px.height;
